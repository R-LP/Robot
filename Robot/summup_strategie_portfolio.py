# -*- coding: utf-8 -*-
"""
Created on Fri Oct  6 11:39:48 2017
...
imp.reload(g_tMC)
benchmark = g_tMC.get_totalMarketCap(start, end)
...
share_percent = mean_best
shares = round(share_percent*initial_capital/data)
