...
def event_profiler(dataset, benchmark, capital):
    ...
    cols = ['Date', 'Pair', 'Order', 'Number of Shares']
    ...
    for s_sym in dataset.columns:
        ...
        for i in range(1, len(ldt_timestamps)):
            ...
            if f_symreturn_today <= -0.03 and f_marketreturn_today >= 0.02:
                ...
                #Open trade
                shares = round(0.2*capital/f_symprice_today)               
                df_events.iloc[k] = [ldt_timestamps[i], s_sym, 'BUY', shares]               
                k+=1
                ...
                time += timeClose
                df_events.iloc[k] = [time, s_sym, 'SELL', shares]
                k+=1
